...
typedef struct avm_table
{
    ...
    struct avm_table_bucket *nilIndexed[AVM_TABLE_HASHSIZE];
    struct avm_table_bucket *undefIndexed[AVM_TABLE_HASHSIZE];
    unsigned int total;
} avm_table;

avm_table *avm_tablenew(void);
void avm_tabledestroy(avm_table *t);
avm_memcell *avm_tablegetelem_key(avm_memcell *key);
void avm_tablesetelem_key(avm_memcell *key, avm_memcell *value);
