...
static const yytype_int16 yyrline[] =
{
     ...
     139,   140,   141,   142,   143,   144,   145,   146,   146,   175,
     175,   203,   204,   208,   209,   216,   227,   240,   256,   269,
     285,   288,   287,   329,   330,   331,   332,   333,   336,   357,
     408,   416,   418,   423,   433,   434,   436,   437,   461,   468,
     475,   482,   487,   492,   500,   521,   527,   537,   540,   551,
     568,   571,   572,   575,   577,   577,   584,   615,   632,   647,
     653,   659,   675,   676,   677,   678,   682,   684,   685,   689,
     701,   704,   704,   718,   722,   735,   741,   755,   769,   775,
     787,   799,   800,   802,   809,   821,   828
};
#endif
...
#line 146 "parser.y"
                        ...
                        if((yyvsp[-1].expression)->type != boolexpr_e){
                            ...
                            //temp->sym = newtemp();
                            emit(if_eq, (yyvsp[-1].expression), newexpr_constbool(1), NULL, nextquadlabel(), yylineno);
...
#line 185 "parser.y"
                        ...
                        if((yyvsp[0].expression)->type != boolexpr_e){
                            ...
                            emit(if_eq, (yyvsp[0].expression), newexpr_constbool(1), NULL, nextquadlabel(), yylineno);
                            emit(jump, NULL, NULL, NULL, nextquadlabel(), yylineno);
                            (yyvsp[0].expression) = temp;
                            temp->truelist =newlist(nextquadlabel()-2);
                            temp->falselist = newlist(nextquadlabel()-1);
...
#line 310 "parser.y"
    ...
    if((yyvsp[-3].expression)->type == tableitem_e){
        ...
        temp->sym = newtemp();
        emit(assign, (yyvsp[-3].expression), NULL,temp, 0U, yylineno);
