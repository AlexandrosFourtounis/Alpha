...
static const yytype_int16 yyrline[] =
{
     ...
     180,   181,   182,   183,   184,   187,   208,   251,   258,   266,
     268,   273,   283,   284,   287,   288,   298,   301,   302,   304,
     306,   308,   309,   312,   313,   317,   318,   319,   326,   327,
     330,   332,   332,   335,   336,   339,   370,   386,   398,   403,
     409,   420,   421,   422,   423,   429,   431,   432,   436,   447,
     450,   450,   462,   465,   466,   468,   470,   472,   472,   473,
     473
};
#endif
...
#line 1702 "parser.c"
  ...
  case 21: /* expr: expr GREATER_EQUAL expr  */
#line 105 "parser.y"
                                              {(yyval.expression) = Manage_comparisonopers((yyvsp[-2].expression), ">=",(yyvsp[0].expression));}
#line 1708 "parser.c"
    break;
...
#line 1714 "parser.c"
  ...
  case 23: /* expr: expr LESS_EQUAL expr  */
#line 107 "parser.y"
                                             {(yyval.expression) = Manage_comparisonopers((yyvsp[-2].expression), "<=",(yyvsp[0].expression));}
#line 1720 "parser.c"
    break;
